 import * as actions from '../../../PatternQuestion/js/action/MetadataAction'
import expect from 'expect' //used any testing library
import metadataConstants from '../../../PatternQuestion/js/constants/MVMConstants';
import marklogicMetadataAPI from '../../../PatternQuestion/js/api/MetadataAPI';
import store from '../../../PatternQuestion/js/store';
import Promise from 'bluebird';
import MetaDataService from '../../../common/util/metadataService';
import * as types from '../../../PatternQuestion/js/constants/MVMConstants';
...
describe('stub getState', () => {
  ...
  it('should return a function in Question Metadata', () => {
    expect(actions.fetchMetaData()).toBeA('function');
  })
...
describe('stub api and returning sucess should work', () => {
 ...
 it('dispatch original QuestionMetaData action', () => {
    actions.fetchMetaData({"uuid":"6e143c65-6abd-4af4-80fd-e1a657c8132f"})(store.dispatch,store.getState);
    setTimeout(function(){
...
describe('stub api and returning error should work', () => {
  ...
  it('dispatch a QuestiontMetaData action', () => {
    actions.fetchMetaData({"uuid":"6e143c65-6abd-4af4-80fd-e1a657c8132f"})(store.dispatch,store.getState);
    setTimeout(function(){
...
describe('stub api and returning sucess should work for Audience Taxonomydata', () => {
  ...
  it('dispatch a QuestionMetaData Audience Taxonomydata action', () => {
  ...
  it('dispatch a QuestiontMetaData DifficultyLevel Taxonomydata action', () => {
    actions.fetchMetaDataTaxonomy(metadata)(store.dispatch,store.getState);
    setTimeout(function(){
      let dispatchArg = dispacthSpy.args[0][0];
      expect(dispacthSpy.called).toEqual(true);
  ...
  it('dispatch a QuestionMetaData Domain Taxonomydata action', () => {
    actions.fetchMetaDataTaxonomy(metadata)(store.dispatch,store.getState);
    setTimeout(function(){
      let dispatchArg = dispacthSpy.args[0][0];
      expect(dispacthSpy.called).toEqual(true);
...
/***********For saveMetaData Function ********/
 ...
 describe('stub api and returning save sucess should work', () => {
  ...
  it('dispatch a Save QuestionMetaData action for SET_ON_LOAD_VALUE', () => {
  ...
  it('dispatch a Save QuestionMetaData action for SET_UUID', () => {
    actions.saveMetaData({"name":"","desc":"aaa"})(store.dispatch, store.getState);
    setTimeout(function(){
...
describe('stub api and returning save update sucess should work', () => {
  ...
  it('dispatch a Save Update QuestionMetaData action for SET_ON_LOAD_VALUE', () => {
  ...
  it('dispatch a Save Update QuestionMetaData action for SET_UUID', () => {
