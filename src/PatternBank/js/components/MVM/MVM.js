 ...
 * @file MVM - This component operates as a "Controller-View".  
 It listens for changes in the AssessmentMetadata Store and passes the new data to its children.
 */
...
/*  <div className="pe-input pe-input--horizontal navcontainer" >
                    <Label for ="Question Name" text={formatMessage(messages.MVM_Name)}/>
                    <TextBox ref="nameInput" required={Boolean(true)} disabled={Boolean(true)}
                     value={name} placeholder="Add a Descriptive Title"/>
  ...
  <div className="pe-input pe-input--horizontal">
                    ...
                    <SelectBox id="contentType" value={contentType} onChange= {this.onChange}
                       onBlur= {this.onBlur} options={contentTypeData}/>
                </div>
      <div className="pe-input pe-input--horizontal" >
                ...
                <div className="pe-input pe-input--horizontal">
                    ...
                    <SelectBox id="goalAlignment"  value={goalAlignment} onChange= {this.onChange} 
                    onBlur= {this.onBlur} options={goalAlignmentData}/>
                </div>
*/
  ...
  const{
    fields : {uuid, filename,name,urn,contentType,audience,modNo,author,
               ...
               <div className={styles.assessmentInput+' '+ styles.assessmentFieldHorizontal+' '+styles.assessmentTimer}>
                <Label for="timeReq" text={formatMessage(messages.Time_Required)}/>
                 ...
                 <div className={styles.assessmentMetaData+' '+styles.assessmentInput+' '+ styles.assessmentFieldHorizontal}>
                    ...
                    <SelectBox id="discipline"   value={discipline} onChange=
                     {this.onChange}   onBlur= {this.onBlur} options={disciplineData}/>
                </div>
                <div className={styles.assessmentMetaData+' '+styles.assessmentInput+' '+ styles.assessmentFieldHorizontal}>
                ...
                <div className={styles.assessmentMetaData+' '+styles.assessmentInput+' '+ styles.assessmentFieldHorizontal}>
                    ...
                    <SelectBox id="difficultLevel"  value={difficultyLevel} onChange= 
                    {this.onChange}   onBlur= {this.onBlur} options={difficultyLevelData}/>
                </div>
                <div className={styles.assessmentMetaData+' '+styles.assessmentInput+' '+ styles.assessmentFieldHorizontal}>
                    <Label for ="Audience Role" text={formatMessage(messages.Audience_Role)}/>
                    <SelectBox id="audienceRole"  value={audience} onChange= {this.onChange} 
                      onBlur= {this.onBlur} options={audienceRolesData}/>
                </div>
                 <div className={styles.assessmentMetaData+' '+styles.assessmentInput+' '+ styles.assessmentFieldHorizontal}>
...
MVMComponent = reduxForm({
    form: 'mvm',
     fields: ['uuid', 'filename','name','urn','isbn','planId','modNo','chapNo',
